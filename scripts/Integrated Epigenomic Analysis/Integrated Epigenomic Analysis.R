...
print("Load differential features")
...
assay.plot <- c("RNA", "H3K27Ac", "H3K4me1", "ATAC")
...
# # Revisions ATAC data
# mat <- read.table(paste0("~/Dropbox/Minn/revisions_NatCancer/data/processed/mat/consensus_mat_tn5_insertion_counts_IDR_vst.txt"), sep="\t", stringsAsFactors=F, header=T)
# gr.atac_revisions <- peakids2GRanges(rownames(mat), delim="_")
# gr.atac_revisions$name <- rownames(mat)
