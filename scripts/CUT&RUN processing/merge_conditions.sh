...
CONTROL_BG=${DIRPATH}/bowtie2/merged/bedgraph/${COND}_IgG.fragments.bedgraph
TREATMENT_BG=${DIRPATH}/bowtie2/merged/bedgraph/${NAME}.fragments.bedgraph

echo "Control sample:" $CONTROL_BG
echo "Treatment sample:" $TREATMENT_BG

bash /home/jingyaq/SEACR_1.3.sh ${TREATMENT_BG} ${CONTROL_BG} norm stringent ${DIRPATH}/seacr/merged/${NAME}_seacr.peaks
bash /home/jingyaq/SEACR_1.3.sh ${TREATMENT_BG} 0.01 norm stringent ${DIRPATH}/seacr/merged/${NAME}_seacr_top0.01.peaks
