...
write.table(na.omit(res.sig$mgi_symbol[res.sig$condition == "R499_SKO"]),
	file = "~/Dropbox/Minn/ifnar_epigenome/Supplementary Data Files/Epigenetic Potential Genes revealed by 499 STAT1 KO.txt", col.names=F, row.names=F, quote=F)
